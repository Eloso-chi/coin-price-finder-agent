...
**All CSV files currently in this folder are SYNTHETIC** -- generated by scripts
in `scripts/generate*.js`, not exported from eBay. They use fake item IDs,
random prices, and hardcoded seller names. They exist as fallback/demo data only.

To get real sold data, follow the manual export workflow below.
