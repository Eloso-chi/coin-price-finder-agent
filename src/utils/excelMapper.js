...
const SERIES_ALIASES = {
  ...
  'perth koala':                       'Australian Silver Koala',
  'perth mint koala':                  'Australian Silver Koala',
  'australian koala':                  'Australian Silver Koala',
  'perth swan':                        'Australian Silver Swan',
  'perth mint swan':                   'Australian Silver Swan',
  'perth emu':                         'Australian Silver Emu',
  'perth mint emu':                    'Australian Silver Emu',
  'perth wedge-tailed eagle':          'Perth Mint Wedge-Tailed Eagle',
  'australian wedge-tailed eagle':     'Perth Mint Wedge-Tailed Eagle',
  'perth quokka':                      'Australian Silver Quokka',
  'perth super pit':                   'Australian Super Pit',
  'rcm .75 oz wild canada series':     'RCM Wild Canada Series 3/4 oz',
  'rcm wildlife':                      'Canadian Wildlife Series',
  'canadian wildlife':                 'Canadian Wildlife Series',
  'rcm birds of prey':                 'Canadian Birds of Prey',
  'canadian birds of prey':            'Canadian Birds of Prey',
  'rcm predator':                      'Canadian Predator Series',
  'canadian predator':                 'Canadian Predator Series',
  'rcm creatures of the north':        'Canadian Creatures of the North',
  'creatures of the north':            'Canadian Creatures of the North',
