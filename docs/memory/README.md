...
| `anti-bot-operations.md` | Non-bypassable challenge stop, risk-state transitions, cooldown recovery gates, telemetry contract, and rollback boundaries for Terapeak operators (#284H). |
